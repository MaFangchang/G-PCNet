...
if __name__ == '__main__':
    ...
    step_name, sample_label = labels[0]
    print(step_name)
    seg_label, inst_label, bottom_label = sample_label['seg'], sample_label['inst'], sample_label['bottom']
    ...
    if args.visual_label == 'seg':
        # visualize face segmented label graph
        ...
        # visualize instance segmented label graph
        node_color = [None for _ in range(len(seg_label))]  # default is background color
        for face_id in seg_label.keys():
            seg_lbl = seg_label[face_id]
            node_color[int(face_id)] = face_colors[seg_lbl]
        ...
        # visualize bottom face segmented label graph
